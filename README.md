...
<table style="width:100%">
  <thead>
    <tr>
      <th style="width:40%;"> <a href="https://gee-why-oh-lxd.github.io/Project-Publish" target="_blank">Using Assist as a Transfer Tool e_learning</a></th>
      <th style="width:60%;">Project Information</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <b>**Context:** My first time using generative AI text-to-speech. I used Bark by Suno, known for its realistic voices. I utilized this for dialogue mirroring daily experience of intended audience, hence the pauses and lingo.<br> </td>
    </tr>
    <tr>
      <td>Jane Smith</td>
      <td>30</td>
